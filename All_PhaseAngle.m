...
% this is the same as Beta_PhaseAngle.m, but instead of looking at trials
% with beta events, we're jsut looking at all trials
% see Cohen.m for a breakdown of the ITPC part
% Using Shin's MEG detection data
% This script d finds the phase angle at
